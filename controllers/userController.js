...
exports.updateMe = catchAsync(async (req, res, next) => {
  ...
  // Filter the fields which are not allowed to be updated like passwordChangedAt, role
...
//This function are only for the admin or tour-guide role
//As if we update here the validation will not run which can create security issues

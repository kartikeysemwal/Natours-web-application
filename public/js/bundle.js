      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Error logging out. Please try again later');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Signup is successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2FydGlrZXlzZW13YWwxMiIsImEiOiJjazk3YjB6dTUwMDE4M2RqeHBsb3Ayb3JzIn0.31niLPEqoWQjxWiTtVN1FA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/kartikeysemwal12/ck97bfmnk6u631ioayt5rfntx',
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend map bounds to the current location
...
var stripe = Stripe('pk_test_wUC3SwQjEO79tZ6gVWiGOO2W00toUiDAtY');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2. Create checkout form + credit card payment
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "65144" + '/');
